...
#define DISPLAY_SDA GPIO_NUM_13  //MOSI
#define DISPLAY_SCL GPIO_NUM_14  //SCK
#define DISPLAY_CS GPIO_NUM_9  //CS
#define DISPLAY_DC GPIO_NUM_21  //RS
#define DISPLAY_RES GPIO_NUM_42 //RST
...
#define DISPLAY_BACKLIGHT_PIN GPIO_NUM_47 //BL
