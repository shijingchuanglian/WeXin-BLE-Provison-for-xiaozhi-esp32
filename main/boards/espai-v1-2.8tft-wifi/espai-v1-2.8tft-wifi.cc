...
#define TAG "ESPAI_V1_28TFT_WIFI"

LV_FONT_DECLARE(font_puhui_20_4);
LV_FONT_DECLARE(font_awesome_20_4);


class ESPAI_V1_28TFT_WIFI : public WifiBoard {
private:
    Button boot_button_;
    ...
    void InitializeButtons() {
        ...
        touch_button_.OnLongPress([this]() {
            ...
            //重启设备，并进入AI对话模式
            ProvisionManager::GetInstance().rebootAndEnterMainApplication();
        });
...
DECLARE_BOARD(ESPAI_V1_28TFT_WIFI);
